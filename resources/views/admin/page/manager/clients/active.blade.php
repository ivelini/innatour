...
@section('content-area')
	<div class="content">
												...
												<div class="dropdown">
													...
													<div class="dropdown-menu dropdown-menu-right">
														<a href="#" class="dropdown-item"
														   data-toggle="modal"
														   data-target="#modal_client_closed"
														   data-id = "{{ $client->id }}"
														><i class="icon-user-check"></i> В закрытые</a>
														<a href="#" class="dropdown-item"
														   data-toggle="modal"
		...
		<div id="modal_client_closed" class="modal fade" tabindex="-1">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="card">
						<div class="card-header bg-light header-elements-inline">
							<h6 class="card-title">Переместить в завершенные?</h6>
						</div>

						<div class="card-body">
							<form method="POST" id="formmodal_close" action="">
								@method('PUT')
								@csrf
...
@section('script')
	...
	<script>
		$('#modal_client_closed').on('shown.bs.modal', function (event) {
			var data_id = $( event.relatedTarget ).data( "id" );
			route = "/manager/client/" + data_id + "/close";
			$("#formmodal_close").attr("action", route)
		});
	</script>
	<script>
