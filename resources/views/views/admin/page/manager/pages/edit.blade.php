	...
	<div class="content">
		...
		<div class="d-flex align-items-start flex-column flex-md-row">
			...
			<div class="w-100 order-2 order-md-1">
				...
				<div class="card">
					<div class="card-body">
						<form method="post" action="{{ route('manager.page.update', $page->id) }}" enctype="multipart/form-data">
							@method('PATCH')
							@csrf
								...
								<div class="form-check form-check-inline form-check-right">
									<label class="form-check-label">
										...
										<input name="is_published"
											   type="checkbox"
											   class="form-check-input-styled" {{ old('is_published', $page->is_published) ? 'checked' : '' }} data-fouc>
									</label>
								</div>
							</div>
							...
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input name="nav_name"
											   type="text"
											   class="form-control"
											   value="{{ old('nav_name', $page->nav_name) }}">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<textarea name="description"
												  ...
												  cols="3"
												  class="form-control"
												  id="summernote">{{ old('description', $page->description) }}</textarea>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										@php
											$location = old('location', $page->location);
										@endphp
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="form-group">
								...
								<input type="text" class="form-control" readonly value="{{ $page->created_at }}">
							</div>

							<div class="form-group">
								<label>Дата обновления</label>
								<input type="text" class="form-control" readonly value="{{ $page->updated_at }}">
							</div>
						</div>
					</div>
					<!-- /form sample -->
